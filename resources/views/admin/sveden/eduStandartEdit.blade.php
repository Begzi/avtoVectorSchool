            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form role="form" method="post" action="{{ route('admin.sveden.eduStandart.update', ['eduStandart' => $eduStandart->id]) }}">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="link_requirements" class="form-control" id="description" rows="7"
                                              placeholder="Введите ссылки ..." >{{ $eduStandart->link_requirements }}</textarea>
                                </div>
                        ...
                        <div class="card-footer">
	                        <a href="{{ route('admin.sveden.eduStandart.index') }}"
